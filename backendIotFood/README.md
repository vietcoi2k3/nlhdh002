...
```
cd existing_repo
git remote add origin https://gitlab.com/linhdv_apec/pos_tablet.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/linhdv_apec/pos_tablet/-/settings/integrations)
